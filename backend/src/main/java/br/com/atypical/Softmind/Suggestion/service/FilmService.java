...
//
//    public FilmsDto getMoviesForEmployee(String employeeId, String surveyId) throws Exception {
...
//
//
//    private String moodGenre(String employeeId, String surveyId) throws Exception {
//        SurveyResponse response = surveyResponseService.countEmployeeResponses(employeeId, surveyId);
//
//        if (response == null || response.getAnswers().isEmpty()) {
//            throw new RuntimeException("Nenhuma resposta encontrada");
//        }
//
//        String mood = response.getAnswers().get(0).getResponse();
//
//        return switch (mood){
//            case "😊" -> "35"; // Comédia
//            case "😢" -> "18"; // Drama
