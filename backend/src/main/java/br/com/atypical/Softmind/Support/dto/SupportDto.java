...
@Schema(description = "Dados de um ponto de apoio (support), incluindo informações de contato")
public record SupportDto(

        @Schema(description = "Identificador único do ponto de apoio", example = "sup123")
        String id,
