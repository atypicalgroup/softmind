            ...
            SoftmindTheme {
                Surface(
                    ...
                    NavHost(
                        ...
                        composable("EmojiScreen") { EmojiScreen(navController = navController) }
                        composable("QuestionScreen") { QuestionsScreen(navController = navController) }
                        composable("EndScreen") { EndScreen(navController = navController) }
